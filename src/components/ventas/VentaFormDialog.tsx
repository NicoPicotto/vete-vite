...
export function VentaFormDialog({
   ...
   // Preparar items para combobox de clientes
   ...
   const handleFormSubmit = async (data: VentaFormValues) => {
      if (cart.length === 0) {
               ...
               >
                  <Card>
                     <CardHeader>
                        ...
                        <CardDescription>
                           Selecciona el cliente y la fecha de la venta
                        </CardDescription>
                     </CardHeader>
                        ...
                        <div className='flex space-x-2 p-3 border-green-500 rounded-lg border'>
                           ...
                           <div className='flex flex-col'>
                              ...
                              <p className='text-sm text-muted-foreground'>
                                 Si está marcado, la venta se registrará como
                  ...
                  <DialogFooter>
                     ...
                     <Button
                        type='submit'
                        disabled={
                           isSubmitting || cart.length === 0 || !clienteId
                        }
                     >
